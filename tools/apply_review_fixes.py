...
FIXES = {
    # восстановление затёртых предложений
    "кайсы?": {"sentence_tt": "Кайсы алма зур? Бу алма зур.",
               "sentence_ru": "Которое яблоко большое? Это яблоко большое.",
               "text_ru": "который?"},
    "иске": {"sentence_tt": "Уенчык иске.", "sentence_ru": "Игрушка старая."},
    ...
    "юла": {"text_ru": "юла", "sentence_tt": "Юла әйләнә.", "sentence_ru": "Юла крутится."},
