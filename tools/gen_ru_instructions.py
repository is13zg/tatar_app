...
INSTRUCTIONS = {
    ...
    "prichina_sobaka": "Там большая собака.",
    "delaet_seychas": "Делает сейчас",
    "uzhe_sdelal": "Уже сделал",
    "demo_where": "Кошка на всех картинках одинаковая. Слушай, где она.",
    "demo_past": "Слушай слово. Если делает сейчас — нажми песочные часы. Если уже сделал — флажок.",
    "demo_count": "Посчитай предметы. Слушай кнопки и выбери, где названо столько же.",
    "demo_why": "Я расскажу, что случилось. А ты выбери, какой он.",
